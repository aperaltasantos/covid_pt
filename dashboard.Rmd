...
library("viridisLite")
    ...
    hcmap(
        ...
        ### js function to change map label from Azores to Açores
        ### not working
        # tooltip = highcharter::JS(
        #     paste0(
        #         "function (tooltip) {
        #     if (this.point.name == 'Azores') {
        #         return 'Açores :' + this.point;
        #     }
        #     // If not null, use the default formatter
        #     return this.point.name + ' :' + this.point;;
        #     }"
        #     )
        # )
    ) %>%
